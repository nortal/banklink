...
package com.nortal.banklink.core.packet.krediidipank;
...
/**
 * A factory for creating KrediidipankPacket objects.
 * 
 * @author ago
 * @version
 */
public class KrediidipankPacketFactory {
    ...
    public static Packet getPacket(String id, Algorithm algorithm) {
        return PacketFactory.getPacket("krediidipank", id, algorithm);
    }
    ...
    public static Packet getPacket(String id, Algorithm algorithm, NonceManager nonceManager) {
        return PacketFactory.getPacket("krediidipank", id, algorithm, nonceManager);
    }
