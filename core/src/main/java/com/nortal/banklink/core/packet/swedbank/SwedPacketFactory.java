...
package com.nortal.banklink.core.packet.swedbank;
...
/**
 * A factory for creating SwedPacket objects.
 * 
 * @author ago
 * @version
 */
public class SwedPacketFactory {
    ...
    public static Packet getPacket(String id, Algorithm algorithm) {
        return PacketFactory.getPacket("swedbank", id, algorithm);
    }
    ...
    public static Packet getPacket(String id, Algorithm algorithm, NonceManager nonceManager) {
        return PacketFactory.getPacket("swedbank", id, algorithm, nonceManager);
    }
