 ...
 */
package com.nortal.banklink.core.packet.lhv;
...
/**
 * A factory for creating LHVPacket objects.
 * 
 * @author Lauri Lättemäe <lauri.lattemae@nortal.com>
 * @since 11.02.2014
 */
public class LHVPacketFactory {
    ...
    public static Packet getPacket(String id, Algorithm algorithm) {
        return PacketFactory.getPacket("lhv", id, algorithm);
    }
    ...
    public static Packet getPacket(String id, Algorithm algorithm, NonceManager nonceManager) {
        return PacketFactory.getPacket("lhv", id, algorithm, nonceManager);
    }
