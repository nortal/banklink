 ...
 */
/*
 * SEBPacketFactory.java
 *
 * Created on April 22, 2002, 12:18 PM
 */
package com.nortal.banklink.core.packet.seb;
...
/**
 * A factory for creating SEBPacket objects.
 */
public class SEBPacketFactory {
    ...
    public static Packet getPacket(String id, Algorithm algorithm) {
        return PacketFactory.getPacket("seb", id, algorithm);
    }
    ...
    public static Packet getPacket(String id, Algorithm algorithm, NonceManager nonceManager) {
        return PacketFactory.getPacket("eyp", id, algorithm, nonceManager);
    }
