SEB pangalingi spetsifikatsioon
Uuendatud: 03.02.14
...
8	VK_NAME		40	STRING	Saaja nimi
...
-	VK_CANCEL	60	STRING	URL, kuhu vastatakse ebaõnnestunud tehingu puhul
-	VK_LANG		3	STRING	Soovitav suhtluskeel
-	VK_CHARSET	12	STRING	Sõnumi kodeering. Mittekohustuslik parameeter. Lubatud ISO-8859-1(vaikeväärtus) või UTF-8
...
PACKET 1902
1	VK_SERVICE		4	INTEGER	Teenuse number
2	VK_VERSION		3	STRING	Kasutatav krüptoalgoritm (008)
3	VK_SND_ID		15	STRING	Päringu koostaja ID (Panga ID)
4	VK_REC_ID		15	STRING	Päringu vastuvõtja ID (Kaupluse ID)
5	VK_STAMP		20	STRING	Päringu ID
6	VK_REF			35	STRING	Maksekorralduse viitenumber
7	VK_MSG			95	STRING	Maksekorralduse selgitus
8	VK_ERROR_CODE	4	STRING	Maksekorralduse selgitus
-	VK_CHARSET		12	STRING	Sõnumi kodeering. Mittekohustuslik parameeter. Lubatud ISO-8859-1(vaikeväärtus) või UTF-8
-	VK_MAC			700	STRING	Kontrollkood e. allkiri
-	VK_LANG			3	STRING	Soovitav suhtluskeel
-	VK_AUTO			1	STRING	Näitab seda, kas pakett oli saadetud automaatselt (`Y`) või mitte (`N`)
...
-	VK_MAC		700	STRING	Kontrollkood e.allkiri
-	VK_CHARSET	10	STRING	Sõnumi kodeering. Vaikeväärtus ISO-8859-1
...
6	VK_RETURN	60	STRING	URL, kuhu suunatakse autenditud kasutaja.
-	VK_MAC		700	STRING	Kontrollkood e. allkiri
-	VK_CHARSET	10	STRING	Sõnumi kodeering. Vaikeväärtus ISO-8859-1
