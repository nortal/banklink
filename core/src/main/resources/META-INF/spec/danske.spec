Sampo pangalingi spetsifikatsioon
Uuendatud: 03.02.14
...
3	VK_SND_ID	14	STRING	Päringu koostaja ID (Kaupluse ID)
...
10	VK_MSG		210	STRING	Maksekorralduse seletus
...
8	VK_MSG		210	STRING	Maksekorralduse seletus
-	VK_MAC		350	STRING	Kontrollkood e. allkiri
-	VK_RETURN	150	STRING	URL, kuhu vastatakse edukal tehingu sooritamisel
-	VK_LANG		3	STRING	Soovitav suhtluskeel
...
2	VK_VERSION	3	STRING	Kasutatav krüptoalgoritm 008
3	VK_SND_ID	14	STRING	Päringu koostaja ID (Panga ID)
4	VK_REC_ID	14	STRING	Päringu vastuvõtja ID (Kaupluse ID)
...
7	VK_MSG		210	STRING	Maksekorralduse selgitus
-	VK_MAC		350	STRING	Kontrollkood e. allkiri
-	VK_LANG		3	STRING	Soovitav suhtluskeel
...
4	VK_DATE		10	DATE	Paketi genereerimise kuupäev
5	VK_TIME		8	TIME	Paketi genereerimise kellaaeg
6	VK_SND_ID	14	STRING	Päringu koostaja ID (Panga ID)
-	VK_MAC		350	STRING	Kontrollkood e.allkiri
-	VK_LANG		3	STRING	Soovitav suhtluskeel
...
6	VK_SND_ID	14	STRING	Sõnumi koostaja ID (Panga ID)
...
2	VK_VERSION	3	STRING	Kasutatav krüptologaritm (008)
3	VK_SND_ID	14	STRING	Sõnumi koostaja (partneri) ID
4	VK_REPLY	4	INTEGER	Oodatava vastuspaketi kood (3002)
5	VK_RETURN	150	STRING	Kaupmehe URL, kuhu vastatakse
...
2	VK_VERSION	3	STRING	Kasutatav krüptologaritm (008)
3	VK_SND_ID	14	STRING	Sõnumi koostaja (partneri) ID
4	VK_REC_ID	14	STRING	Sõnumi saaja (panga) ID
...
2	VK_VERSION	3	STRING	Kasutatav krüptologaritm (008)
3	VK_SND_ID	14	STRING	Sõnumi koostaja ID (Panga ID)
4	VK_REC_ID	14	STRING	Sõnumi saaja (partneri) ID
